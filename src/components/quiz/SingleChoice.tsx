...
export default function SingleChoice({ title, content, options, correctAnswer, onSubmit }: SingleChoiceProps) {
    ...
    <div className="bg-white rounded-lg shadow-md p-6 max-w-2xl mx-auto">
      ...
      <div className="space-y-3 mb-6">
        {options.map((option) => (
          <label
            key={option.id}
            className={`flex items-center p-4 border-2 rounded-lg cursor-pointer transition ${selectedOption === option.id
